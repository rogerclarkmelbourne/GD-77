...
firmware_find_shift GD-77_V3.2.2_0A0B_077801 datafile search_endpattern >> results_search_endpattern.txt
...
firmware_find_shift BF-860_V3.1.9_FDBC4_078001 datafile search_endpattern >> results_search_endpattern.txt
pause
